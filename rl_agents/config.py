...
def get_config():
    ...
    parser.add_argument(
        "--verbose",
        action='store_true',
        help="print config setting for our env"
    )
    parser.add_argument(
        "--reward_type",
        '-r',
    ...
    parser.add_argument(
        "--pretrained_fpath",
        type=str,
        default='rl_training/logging/single_tractor_sac_24',
        help="where to find the model"
    )
    parser.add_argument(
        "--pretrained_itr",
        '-pitr',
